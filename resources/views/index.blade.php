...
<head>
    ...
    <script src="{{ url('index.js') }}" defer="true"></script>
</head>
<body>
    <nav id="topnavbar">
        <h1 id="title">
    ...
    <section>
        ...
        <nav id="subnavbar">
            <div id="flex-container">
                ...
                <a href="{{ url('login') }}" id="link2"> ACCEDI </a>
            </div>
        </nav>
        <div class="welcome-box">
            <h1>FANTACALCIO</h1>
            <img src="{{ url('immagini/image1.png') }}" id="blocco-iniziale" />
            <h5> IL SITO UFFICIALE DELLA SERIE A TIM </h5>
            <div class="gioca">
                <h4>INIZIA A SCOPRIRE! </h4>
            </div>
            <div class="flex-benvenuto">
                <div class="crealega">
                    <h6> VUOI REGISTRARTI AL SITO PER AVERE INFO <br> SULLE NEWS LEGATE AL CALCIO?</h6>
                    <a href="{{ url('register') }}" id="link3"> REGISTRATI </a>
                </div>
