...
<head>
    ...
    <meta charset="utf-8">
    <title> Fantacalcio - <?php echo e($utente->username); ?> </title>
    <link rel="stylesheet" href="<?php echo e(url('home.css')); ?>">
    ...
    <script src="<?php echo e(url('scripts.js')); ?>" defer="true"></script>
    <script src="<?php echo e(url('home.js')); ?>" defer="true"></script>
</head>
<body>
    <nav id="topnavbar">
        <h1 id="title">
    ...
    <section>
        ...
        <nav id="subnavbar">
            <div id="flex-container">
                <div id="menu-tendina">
                    <img src="<?php echo e(url('immagini/menu.png')); ?>" />
                    <div id="menu_item" class="hidden">
                        <a href="<?php echo e(url('profile')); ?>">PROFILO</a>
                        <a href="<?php echo e(url('fanpage')); ?>">FANPAGE FANTACALCIO</a>
                    </div>
                </div>
                <div id="utente-loggato">
                    <div id="struttura"> <span>
                        <?php echo e(substr($utente->username, 0 , 1)); ?>
                    ...
                    <div id="informazioni-utente" class="hidden">
                        <div>
                            ...
                            <?php echo e($utente->username); ?>

                                </span> </li>
                            <li><strong>E-Mail:</strong> <span>
                                <?php echo e($utente->email); ?>
                    ...
                    <div id="pubblicita">
                        <div id="mistery-box">
                            <h1> Clicca Mago Merlino per conoscere la sua previsione <br> sull'esito della tua giornata
                                al Fantacalcio! </h1>
                            <img src="<?php echo e(url('immagini/magomerlino.png')); ?>" />
                        </div>
                        <div id="win-box" class="hidden">
                            <img src="<?php echo e(url('immagini/mago.jpeg')); ?>" />
                        </div>
                        <div id="lose-box" class="hidden">
                            <img src="<?php echo e(url('immagini/mago2.jpg')); ?>" />
                        </div>
                    </div>
                    <div id="regole">
                        <div id="box">
                            <div class="riga">
                                <div class="immagine">
                                    <img src="<?php echo e(url('immagini/dispositivi.png')); ?>">
                                    <p>
                                ...
                                <div class="immagine">
                                    <img src="<?php echo e(url('immagini/calcolatrice.png')); ?>">
                                    <p>
                            ...
                            <div class="riga">
                                <div class="immagine">
                                    <img src="<?php echo e(url('immagini/calcio.png')); ?>">
                                    <p>
                                        Voti LIVE! per seguire l'andamento della tua squadra in tempo reale
                                    </p>
                                </div>
                                <div class="immagine">
                                    <img src="<?php echo e(url('immagini/agenda.png')); ?>">
                                    <p>
