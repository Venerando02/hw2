...
function resetcatalog(event){
    clearContainer();
    const flex_container = document.querySelector('#f-container1');
    flex_container.appendChild(colonna1);
    flex_container.appendChild(colonna2);
}

const button1 = document.querySelector('#b1');
button1.addEventListener('click', resetcatalog);